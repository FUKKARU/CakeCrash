...
{
    [SerializeField] private Material material; // クリーム用のマテリアル

    private const int MaxSphereCount = 1000; // 球の最大個数（シェーダー側と合わせる）
    ...
    private void Start()
    {
        ...
        {
            _colors[i] = (Vector4)Random.ColorHSV(0.5f, 0.5f, 0, 0, 1,1);
        }
